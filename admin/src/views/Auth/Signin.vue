<template>
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div
        class="relative flex flex-col justify-center items-center w-full h-screen dark:bg-gray-900"
      >
        <div class="w-full max-w-md mx-auto p-6 sm:p-0">
          <div>
            <div class="mb-5 sm:mb-8 text-center">
              <img src="/logo.png" alt="Bambu Cloud" class="h-16 w-auto mx-auto mb-6" />
              <h1
            ...
            <div>
              <form @submit.prevent="handleSubmit">
                <!-- Error message -->
                <div v-if="errorMsg" class="mb-4 rounded-lg border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20 px-4 py-3 text-sm text-red-600 dark:text-red-400">
                  {{ errorMsg }}
                </div>
                <div class="space-y-5">
                  <!-- Usuario -->
...
const handleSubmit = async () => {
  ...
  loading.value = true
  try {
    await login(usuario.value, contraseña.value)
    router.push('/')
  } catch (e: any) {
