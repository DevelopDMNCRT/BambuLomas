<template>
  <AdminLayout>
    <div class="p-6">
      ...
      <!-- Empty State -->
      <div v-else-if="platillos.length === 0" class="rounded-2xl border border-gray-200 bg-white p-6 text-center text-gray-500 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400">
        <div class="py-12">
